...
const moretti = new Beer ('moretti ipa', 'moretti s.p.a', 2024, 66, 4, "bottleNumber (valore da mettere)", 'ipa', 'blonde');  

//Creare una classe Wine che estende Beverage con le seguenti proprietà:
//vite, location

const dolcetto = new Wine ('dolcetto bella vita', 'cantine bella vita', 2020, 75, 11, "bottleNumber (valore da mettere)", 'dolcetto', 'alba')

//Creare una classe PremiumWine che estende Wine con le seguenti proprietà:
//certification

const barolo = new PremiumWine ('brunate barolo', 'cantine brugnate', 2021, 75, 14, "bottleNumber (valore da mettere)", 'nebbiolo da barolo', 'piemonte', 'D.O.C.G');
